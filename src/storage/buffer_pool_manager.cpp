...
Page *BufferPoolManager::fetch_page(PageId page_id)
{
    ...
    std::unordered_map<PageId, frame_id_t, PageIdHash>::iterator iter = page_table_.find(page_id);
...
bool BufferPoolManager::flush_page(PageId page_id)
{
    ...
    frame_id_t frame_id = iter->second;
    Page *dest_page = &pages_[frame_id];
    disk_manager_->write_page(dest_page->get_page_id().fd, dest_page->get_page_id().page_no, dest_page->get_data(), PAGE_SIZE);
    dest_page->is_dirty_ = false;
    return true;
}
